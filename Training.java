public class Training {
    ...
    public void burpeeYap(int sayi) {
        if (burpee_sayisi == 0) {
            System.out.println("Yapacak burpee sayısı kalmadı...");
        }
        if (burpee_sayisi - sayi < 0) {
            System.out.println("Tebrikler! Hedef burpee sayısını geçtiniz...");
            burpee_sayisi = 0;
    ...
    public void pushupYap(int sayi) {
        ...
        if (pushup_sayisi - sayi < 0) {
            System.out.println("Tebrikler! Hedef pushup sayısını geçtiniz...");
            pushup_sayisi = 0;
    ...
    public void situpYap(int sayi) {
        ...
        if (situp_sayisi - sayi < 0) {
            System.out.println("Tebrikler! Hedef situp sayısını geçtiniz...");
            situp_sayisi = 0;
    ...
    public void squatYap(int sayi) {
        ...
        if (squat_sayisi - sayi < 0) {
            System.out.println("Tebrikler! Hedef squat sayısını geçtiniz...");
            squat_sayisi = 0;
